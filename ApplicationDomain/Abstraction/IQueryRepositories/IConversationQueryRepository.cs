...
{
    public Task<Conversation?> GetConversationPlainByJobSeekerAndEmployerJobIds(int jobSeekerId, int employerId, int jobId);
    public Task<Conversation?> GetConversationFullInfoByJobSeekerAndEmployerJobIds(int jobSeekerId, int employerId, int jobId);
