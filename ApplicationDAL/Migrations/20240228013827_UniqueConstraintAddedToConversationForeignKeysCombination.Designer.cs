...
namespace ApplicationDAL.Migrations
{
    ...
    [Migration("20240228013827_UniqueConstraintAddedToConversationForeignKeysCombination")]
    partial class UniqueConstraintAddedToConversationForeignKeysCombination
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ApplicationDomain.MessagingRelatedModels.Conversation", b =>
                {
                    ...
                    b.HasIndex("EmployerId", "JobSeekerId", "JobId")
                        .IsUnique();
