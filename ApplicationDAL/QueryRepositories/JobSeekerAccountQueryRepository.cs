...
public class JobSeekerAccountQueryRepository : IJobSeekerAccountQueryRepository
{
    ...
    public JobSeekerAccountQueryRepository(ApplicationContext applicationContext,
    ...
    private async Task<JobSeekerAccount> GetUserWithJobSeekerAccount(int userId,
