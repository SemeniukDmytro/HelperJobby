...
public class CurrentJobCreationQueryRepository : ICurrentJobCreationQueryRepository
{
    ...
    private async Task<CurrentJobCreation> GetCurrentJob(int jobCreationId,
        Func<IQueryable<CurrentJobCreation>, IQueryable<CurrentJobCreation>> includeQuery = null)
    {
