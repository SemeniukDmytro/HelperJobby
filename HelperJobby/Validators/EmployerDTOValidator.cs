...
public class EmployerDTOValidator : AbstractValidator<CreateEmployerDTO>
{
    ...
    public static void ValidateAccount(CreateEmployerDTO account)
    {
        ...
        var validator = new EmployerDTOValidator();
