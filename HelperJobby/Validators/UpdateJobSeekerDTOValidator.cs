...
public class UpdateJobSeekerDTOValidator : AbstractValidator<UpdatedJobSeekerDTO>
{
    public UpdateJobSeekerDTOValidator()
    {
    ...
    public static void ValidateAccount(UpdatedJobSeekerDTO account)
    {
        if (!string.IsNullOrEmpty(account.PhoneNumber)) CommonValidator.BeValidPhoneNumber(account.PhoneNumber);
        var validator = new UpdateJobSeekerDTOValidator();
